...
namespace NewEffects
{
    ...
    
    {
        ...
        public void AddStatusEffects()
        {
            ...
            holySwordEffect.m_icon = AssetUtils.LoadSpriteFromFile("C:\\Users\\Norman\\RiderProjects\\NewEffects\\Assets\\reee.png");
            ...
            moreHpEffect.m_icon = AssetUtils.LoadSpriteFromFile("C:\\Users\\Norman\\RiderProjects\\NewEffects\\Assets\\shieldicon.png");
            ...
            lightArmorEffect.m_icon = AssetUtils.LoadSpriteFromFile("C:\\Users\\Norman\\RiderProjects\\NewEffects\\Assets\\lightArmorIcon.png");
...
;
        ...
        private void LoadAssets()
        {
           ...
           Jotunn.Logger.LogInfo($"Embedded resources: {string.Join(", ", typeof(NewEffects).Assembly.GetManifestResourceNames())}");
        ...
        public class ChangeDurability
        {
            ...
            static void addEffectToPlayer()
            {
                ...
                if (Input.GetKey(KeyCode.Keypad9) && Player.m_localPlayer.m_uniques.Contains("Paladin") )
                {
